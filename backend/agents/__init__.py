...
# This allows imports like: from modules.agents.models.agent import AgentModel
import sys
...
# Make src.models accessible as modules.agents.models
...
class Module:
    name = "agents"  # si o si, snake case
    dependencies = []
    ...
    def register_services(self):
        ...
        self.container.register("agents", lambda: Funcionalities(self.container, database_key=database_key))
