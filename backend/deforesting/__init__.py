...
# This allows imports like: from modules.deforesting.models.deforestation_requests import DeforestationRequestModel
import sys
...
# Make src.models accessible as modules.deforesting.models
...
class Module:
    name = "deforesting"  # si o si, snake case
    dependencies = []
    ...
    def register_services(self):
        ...
        self.container.register("deforesting", lambda: Funcionalities(self.container, database_key=database_key))
