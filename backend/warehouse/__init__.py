...
# This allows imports like: from modules.warehouse.models.store_centers import StoreCenterModel
import sys
...
# Make src.models accessible as modules.warehouse.models
...
class Module:
    name = "warehouse"  # si o si, snake case
    dependencies = []
    ...
    def register_services(self):
        ...
        self.container.register("warehouse", lambda: Funcionalities(self.container, database_key=database_key))
