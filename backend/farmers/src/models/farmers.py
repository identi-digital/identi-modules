...
class FarmerModel(Model):
  ...
  first_name: str = Column(String(50), nullable=False, info={"display_name": "Nombre", "description": "nombre del productor"})
  last_name: str = Column(String(50), nullable=False, info={"display_name": "Apellido", "description": "apellido del productor"})
  dni: str = Column(String(20), unique=True, nullable=False, info={"display_name": "DNI", "description": "dni del productor"})
  wsp_number = Column(String(25), info={"display_name": "Número de WhatsApp", "description": "numero de whatsapp del productor"})
  sms_number = Column(String(25), nullable=False, info={"display_name": "Número de SMS", "description": "numero de sms del productor"})
