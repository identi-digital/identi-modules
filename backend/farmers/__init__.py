...
# This allows imports like: from modules.farmers.models.farmers import FarmerModel
import sys
...
# Make src.models accessible as modules.farmers.models
...
class Module:
    name = "farmers"  # si o si, snake case
    dependencies = []
    ...
    def register_services(self):
        ...
        self.container.register("farmers", lambda: Funcionalities(self.container, database_key=database_key))
