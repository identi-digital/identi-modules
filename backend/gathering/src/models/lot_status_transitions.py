...
@dataclass
class LotStatusTransitionModel(Model):
    """ LotStatusTransitionModel """
    
    __tablename__ = "lot_status_transitions"
    __table_args__ = (
        Index('idx_lst_lot', 'lot_id'),
    ...
    last_status: str = Column(String(100), nullable=False, info={"display_name": "Estado Anterior", "description": "estado anterior del lote"})
    new_status: str = Column(String(100), nullable=False, info={"display_name": "Nuevo Estado", "description": "nuevo estado del lote"})
    ...
    def __init__(self, **kwargs):
        super(LotStatusTransitionModel, self).__init__(**kwargs)
